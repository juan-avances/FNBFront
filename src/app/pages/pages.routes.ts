...
import { OfflineIndexComponent } from './administracion/mantenimientos/offline/offline-index/offline-index.component';
import { Auth2Guard } from '../guards/auth2.guard';
import { AuthGestorUsuarioGuard } from '../guards/auth-gestor-usuario.guard';
import { DesbloqueoUsuarioComponent } from './administracion/desbloqueo-usuario/desbloqueo-usuario.component';
import { AuthGestorOperacionGuard } from '../guards/auth-gestor-operacion.guard';
...
const pagesRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'consulta-motorizado',
        component: ConsultaMotorizadoComponent,
        data: { titulo: 'Consulta Motorizado' }
      },
      {
      ...
      {
        path: 'offline-index',
        component: OfflineIndexComponent,
        data: { titulo: 'Mantenimiento Offline' },
        canActivate: [AuthGuard]
      },
      {
        path: 'category-form',
	  ...
	  {
        path: 'call-center',
        component: LandingPageCallCenterComponent,
        data: { titulo: 'Landing Page Call Center' }
      },
      {
      ...
      },
      {
        ...
        component: DesbloqueoUsuarioComponent,
        data: { titulo: 'Desbloquear usuario' },
        canActivate: [AuthGuard]
      },
      {
      ...
      {
        path: 'validacion-motorizado',
        component: ValidacionMotorizadoComponent,
        data: { titulo: 'Validación de motorizado' },
        canActivate: [AuthGuard]
      },
    ]
  }
